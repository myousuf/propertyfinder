...
public class Settings {
	...
	public static String getFontSize(Context c) {
		...
		// return sharedPref.getString(PREF_FONTSIZE,
		// c.getString(R.string.pref_default_fontsize));
		return "";
	}
	...
	public static String getHtmlProvider(Context c) {
		...
		// SharedPreferences sharedPref =
		// PreferenceManager.getDefaultSharedPreferences(c);
		// return sharedPref.getString(PREF_HTMLPROVIDER,
		// c.getString(R.string.pref_default_htmlprovider));
		return "";
	...
	public static String getHtmlViewer(Context c) {
		...
		// SharedPreferences sharedPref =
		// PreferenceManager.getDefaultSharedPreferences(c);
		// return sharedPref.getString(PREF_HTMLVIEWER,
		// c.getString(R.string.pref_default_htmlviewer));
		return "";
	}
	...
	public static String getUserName(Context c) {
		...
		String[] userData = sharedPref.getString(PREF_USER, "").split(
				USER_DATA_SEPARATOR);
	...
	public static void setUserData(String userName, String userToken, Context c) {
		...
		sharedPref
				.edit()
				.putString(PREF_USER,
						userName + USER_DATA_SEPARATOR + userToken).commit();
	}
